...
from .views import Create_Course, ListCoursesView, Course_Detail, Add_Comment_View, Create_Requisite_View, Add_Courses_Library, Add_Paid_Courses_Library, Delete_Course
